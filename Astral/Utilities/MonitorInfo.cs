...
namespace Astral.Utilities
{
    ...
    public class MonitorInfo : IUtility
    {
        ...
        public WinPoint ScreenPointToClient(WinPoint point)
        {
        ...
        public int GetMonitorDpiFromPoint(WinPoint pt, MonitorDpiType dpiType)
        {
